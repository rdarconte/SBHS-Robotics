...
import frc.robot.autos.SimpleCoralAutoLeft;
import frc.robot.autos.DriveAroundAuto;
...
public class RobotContainer {
  ...
  public final SimpleCoralAutoLeft m_simpleCoralAutoLeft = new SimpleCoralAutoLeft(m_drive, m_roller, m_arm);
  public final DriveForwardAuto m_driveForwardAuto = new DriveForwardAuto(m_drive);
  public final DriveAroundAuto m_driveAroundAuto = new DriveAroundAuto(m_drive);
  ...
  public RobotContainer() {
    ...
    m_chooser.addOption("Coral Auto Left", m_simpleCoralAutoLeft);
    m_chooser.addOption("Drive Forward Auto", m_driveForwardAuto);
    m_chooser.addOption("Drive Around Auto", m_driveAroundAuto);
